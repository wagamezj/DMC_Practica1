...
###################LIBRERIAS ADICIONALES IMPORTADAS PARA LA PRACTICA##################################################
...
class TextPreprocessor:
    ...
    def __init__(self, remove_links=True, remove_hastags=True,
                  ...
                  remove_emojis=True, remove_numbers=True,remove_stopwords_flag= True, stemming = True, lemmatization = True):
        ...
        self.stemming_flag = stemming
        self.lemmatization_flag = lemmatization
    ...
    ################################ CODIGO INSERTADO PARA LA PRACTICA##################################################################################
    
    def stemming_activate(self,text):
        if isinstance(text, list):
            stemmer = PorterStemmer()
            return ' '.join([stemmer.stem(word) for word in text])

    def lemmatization_activate(self,text):
        if isinstance(text, list):
            lemmatizer = WordNetLemmatizer()
            return ' '.join([lemmatizer.lemmatize(word) for word in text])
    
    #################################FIN CODIGO INSERTADO PARA LA PRACTICA#############################################################################
    ...
    def preprocess_text(self, text):
        ...
        ############################################# INVOCACION DE LA FUNCION SI LA VARIABLE ESTA ACTIVA######################################
        if self.lemmatization_flag:
            text = self.lemmatization_activate(text.split())
        if self.stemming_flag:
            text = self.stemming_activate(text.split())
